<h2 align="left"><span><?php if(isset($college_data[0]['id'])) echo 'Edit'; else echo 'Add'; ?> Section</span></h2>
...
-->
        <li>
            <input type="button" name="imageField" id="imageField" class="send button j_gen_form_submit" value="Save Section" />
            <div class="clr"></div>
        </li>
    </ol>
</form>