<h2 align="left"><span><?php if(isset($college_data[0]['id'])) echo 'Edit'; else echo 'Add'; ?> Academic Year</span></h2>
...
<form id="edit_academic_year_form" action="" method="POST">
    ...
    <ol>
        ...
        <li>
            <input type="submit" name="imageField" id="imageField" class="send button j_gen_form_submit" value="Save Academic Year" />
            <div class="clr"></div>
        </li>
    </ol>
</form>
