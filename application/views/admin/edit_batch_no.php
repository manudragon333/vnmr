...
<h2 align="left"><span><?php if(isset($college_data[0]['id'])) echo 'Edit'; else echo 'Add'; ?> Batch No</span></h2>
...
<form id="edit_batch_no_form" action="" method="POST">
    ...
    <ol>
        ...
        <li>
            <input type="submit" name="imageField" id="imageField" class="send button " value="Save Batch No" />
            <div class="clr"></div>
        </li>
    </ol>
</form>
