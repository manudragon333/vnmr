<h2 align="left"><span><?php if(isset($college_data[0]['id'])) echo 'Edit'; else echo 'Add'; ?> College</span></h2>
...
<!--            <input id="college_address" name="college_address" class="text" value="">-->
        ...
        <li>
            <input type="submit" name="imageField" id="imageField" class="send button " value="Save College" />
            <div class="clr"></div>
        </li>
    </ol>
</form>
